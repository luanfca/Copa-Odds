...
export default function FaltasSofridasPage() {
  ...
  const load = useCallback(async () => {
    const cached = getCachedMarket('faltas_sofridas', allComps) as ApiResponse | null;
    if (cached) {
        ...
        <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground/50 max-w-md leading-relaxed">
              Jogadores ranqueados por média de faltas sofridas nos últimos jogos da Copa, com as melhores odds disponíveis.
            </p>
          </div>
      ...
      {!loading && !error && (
        <div className="p-4 rounded-2xl border border-white/[0.04] bg-white/[0.015]">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mt-4 pt-3 border-t border-white/[0.04]">
            ...
            <button
              onClick={() => { invalidateMarket('faltas_sofridas'); load(); }}
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="flex flex-col min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              {isStarter && (
                <span title="Provável titular" className="text-rose-400 shrink-0">
