...
>(({ className, variant = 'default', ...props }, ref) => (
  <ToastPrimitives.Root
    ...
    className={cn(
      ...
      'space-x-4 overflow-hidden rounded-xl border p-5 pr-8 shadow-2xl',
      ...
      variant === 'default' && 'bg-card border-border/50 text-foreground',
...
export {
  ...
  ToastTitle, ToastDescription, type ToastProps,
};
